...
export default function IletisimPage() {
  ...
  return (
    <main>
      <PageHead title="İletişim" description="Hukuki danışmanlık ve randevu talepleriniz için bizimle iletişime geçebilirsiniz." canonical="/iletisim" />
      ...
      <section className="py-20">
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid gap-12 lg:grid-cols-2">
            <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
              ...
              <div className="space-y-4">
                {contactItems.map(({ icon: Icon, label, value, detail, href }) => (
                  <motion.div key={label} variants={fadeUp} className="flex items-start gap-4 border border-gray-100 p-5 transition-colors hover:border-gold/30">
            ...
            <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.65, delay: 0.2 }} className="flex flex-col justify-center">
              <div className="relative overflow-hidden border border-gray-100 bg-surface p-8">
                ...
                <p className="mt-5 text-sm text-gray-600 leading-relaxed">
                  Ön görüşme ve danışmanlık randevusu için telefon veya e-posta yoluyla büromuzla iletişime geçebilirsiniz.
                </p>
                <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                  İlk görüşmelerde davanız ya da hukuki durumunuz hakkında ön değerlendirme yapılmakta; süreç ve olası sonuçlar hakkında bilgi verilmektedir.
                </p>
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  <a href="tel:+905001234567" className="inline-flex items-center justify-center gap-2 bg-navy px-6 py-3 text-sm text-white transition-opacity hover:opacity-90">
                    <Phone size={14} />
                    Hemen Ara
                  </a>
                  <a href="mailto:info@isikavukatlik.com?subject=Randevu%20Talebi" className="group inline-flex items-center justify-center gap-2 border border-navy px-6 py-3 text-sm text-navy transition-all hover:bg-navy hover:text-white">
                    E-posta Gönder
