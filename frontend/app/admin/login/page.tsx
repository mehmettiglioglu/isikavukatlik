...
function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      document.cookie = `admin_token=${data.token}; path=/admin; max-age=${8 * 3600}; SameSite=Strict`;
      router.push(from);
      router.refresh();
    } catch {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f8f7f4]">
      ...
      <div className="absolute inset-0 z-0 opacity-30">
        <Image src="/justice.jpg" alt="" fill className="object-cover" sizes="100vw" />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="relative mb-4 h-16 w-16">
            <Image src="/pnglogoısık.png" alt="Işık Hukuk Bürosu" fill className="object-contain" sizes="64px" priority />
          </div>
        ...
        <div className="border border-gray-200 bg-white shadow-sm">
          ...
          <form onSubmit={handleSubmit} noValidate className="px-8 py-7 space-y-5">
            {/* Kullanıcı adı */}
            <div>
              <label htmlFor="username" className="mb-1.5 block text-xs font-medium uppercase tracking-wider text-gray-500">
                Kullanıcı Adı
              </label>
            ...
            {/* Şifre */}
            <div>
              <label htmlFor="password" className="mb-1.5 block text-xs font-medium uppercase tracking-wider text-gray-500">
                Şifre
              </label>
              <div className="relative">
            ...
            <button
              type="submit"
              disabled={loading}
              className="relative w-full overflow-hidden bg-navy py-3 text-sm font-medium text-white transition-opacity hover:opacity-90 disabled:opacity-60"
            >
              {loading ? (
