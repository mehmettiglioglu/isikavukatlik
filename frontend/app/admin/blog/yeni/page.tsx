    ...
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={saving}
            className="inline-flex items-center gap-2 border border-gray-200 bg-white px-4 py-2 text-sm text-gray-600 transition-colors hover:border-navy hover:text-navy disabled:opacity-50"
          >
            <EyeOff size={14} />
            Taslak Kaydet
          </button>
          <button
            ...
            disabled={saving}
            className="inline-flex items-center gap-2 bg-navy px-5 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90 disabled:opacity-60"
          >
            {saving
      ...
      {success && (
        <div className="mb-4 flex items-center gap-2.5 border border-green-100 bg-green-50 px-4 py-3 text-sm text-green-700">
          ...
          Makale başarıyla kaydedildi. Yönlendiriliyorsunuz...
        </div>
      )}
        ...
        <div className="space-y-5">
          <div className="border border-gray-200 bg-white p-6 space-y-5">
            <div>
              ...
              <input
                type="text" required value={form.title} onChange={handleTitle}
                className={FIELD} placeholder="Makale başlığı"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className={FIELD} placeholder="Kısa özet (liste görünümünde gösterilir)"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                rows={16} required value={form.content}
          ...
          <div className="border border-gray-200 bg-white p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={FIELD} placeholder="SEO başlığı (boş bırakılırsa makale başlığı kullanılır)"
              />
            ...
            <div>
              ...
              <textarea
                rows={2} value={form.metaDescription}
                onChange={(e) => setForm((p) => ({ ...p, metaDescription: e.target.value }))}
                className={FIELD} placeholder="Arama sonuçlarında görünen açıklama"
              />
            ...
            <div className="space-y-3">
              <div
                ...
                className={`flex cursor-pointer items-center gap-3 border p-3 transition-colors ${
                  !form.isPublished ? "border-amber-300 bg-amber-50" : "border-gray-100 hover:border-gray-200"
                }`}
              >
              ...
              <div
                ...
                className={`flex cursor-pointer items-center gap-3 border p-3 transition-colors ${
                  form.isPublished ? "border-green-300 bg-green-50" : "border-gray-100 hover:border-gray-200"
                }`}
              >
          ...
          <div className="border border-gray-200 bg-white p-5">
            ...
            {form.coverImageUrl && (
              <div className="mt-3">
                ...
                >
                  <ImageIcon size={12} />
                  {previewImage ? "Önizlemeyi gizle" : "Önizle"}
                </button>
                {previewImage && (
