    ...
    <main>
      ...
      <section className="relative overflow-hidden bg-navy py-24">
        <div className="absolute inset-0 z-0">
          <Image src="/justice3.jpg" alt="" fill className="object-cover opacity-15" sizes="100vw" />
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              <div className="relative aspect-4/3 overflow-hidden">
                ...
                />
                {/* Alt gradient — fotoğrafı karanlıklaştırıp içerik bloğuyla uyumlu kılar */}
          ...
          >
            {partners.map((partner) => (
              <motion.div
                key={partner.name}
                variants={fadeUp}
                className="bg-white p-8 border-l-2 border-gold"
              >
          ...
          >
            {values.map(({ icon: Icon, title, description }) => (
              <motion.div
                key={title}
                variants={fadeUp}
                className="flex items-start gap-4 p-6 border border-gray-100 hover:border-gold/30 transition-colors"
              >
